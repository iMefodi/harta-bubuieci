/* Portal WebGIS Bubuieci — limba RO/EN, taburi harti, lightbox, meniu mobil, animatii */
(function () {
  'use strict';

  // ---------------- traduceri (RO = textul din HTML, EN = mai jos) ----------------
  var EN = {
    'nav.sub': '· PBL UTM', 'nav.story': 'Story', 'nav.maps': 'Interactive maps', 'nav.data': 'Data',
    'nav.labs': 'Labs', 'nav.links': 'Useful links', 'nav.contact': 'Contact',
    ...
    'hero.alt': 'Map of the built-up area in the centre of Bubuieci',
    'card1.t': 'The Bubuieci story', 'card1.d': 'Five chapters, five thematic maps and the numbers that describe the village.',
    'card2.t': 'Interactive maps', 'card2.d': 'Explore the layers with zoom, search and information pop-ups.',
    'card3.t': 'Downloadable maps', 'card3.d': 'The thematic maps as 200 dpi PNG files, ready to print.',
    'card4.t': 'Project journal', 'card4.d': 'The seven PBL lab works, step by step.',
    'more': 'Learn more ›',
    ...
    'story.p': 'A GIS analysis based on open (OpenStreetMap) and official (cadastral) data, accessible to everyone — residents, local authorities, investors and students.',
    'zoom': 'Enlarge ⤢',
    ...
    'c2.call': 'CORINE Land Cover confirms it: arable land 47 %, discontinuous urban fabric 23 %, pastures 13 %, forests 8 %.',
    ...
    'c3.p2': 'Buildings cover only <strong>1.7 %</strong> of the land and the typical parcel is <strong>730 m²</strong>. The village is growing: cadastral changes rose from 24 in 2017 to <strong>159 in 2025</strong>.',
    ...
    'c4.p2': 'The link to the city: <strong>49 bus stops</strong> along the main roads.',
    ...
    'dl.h': 'Thematic maps. <span>Download and use.</span>',
    ...
    'labs.h': 'Project journal. <span>Seven PBL labs.</span>',
    ...
    'l5.t': 'WebGIS storytelling', 'l5.d': 'Five thematic maps, the story of the village and this portal.',
    ...
    'lk.corine': 'European land cover, Copernicus programme.',
    ...
    'ft.src': 'Sources: © OpenStreetMap contributors · cadastral data, sector 0142 · Copernicus CORINE Land Cover · NSDI / geodata.gov.md',
  ...
  document.querySelectorAll('.ch-img').forEach(function (fig) {
    ...
    function open() {
      ...
      lbDl.href = fig.getAttribute('data-png');
      lb.classList.add('on');
  ...
  document.querySelectorAll('[data-scroll]').forEach(function (b) {
    b.addEventListener('click', function () {
      sc.scrollBy({ left: Number(b.getAttribute('data-scroll')) * 360, behavior: 'smooth' });
    });
  });
